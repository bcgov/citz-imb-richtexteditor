[![Package Status](https://github.com/bcgov/citz-imb-richtexteditor/actions/workflows/publish.yaml/badge.svg)](https://github.com/bcgov/citz-imb-richtexteditor/actions/workflows/publish.yaml)
